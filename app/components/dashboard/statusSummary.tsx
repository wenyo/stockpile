    ...
    <Card className="h-full border-border/50 bg-card/40 backdrop-blur-sm">
      ...
      <CardContent className="flex flex-col gap-2">
        <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4">
          ...
          <p className={`${level?.className} flex items-center gap-2 text-xl md:text-2xl font-bold tracking-wider mb-1`}>{level?.label}<Info className="text-muted-foreground" size={16} onClick={() => openModal("statusInfo")} /></p>
        </div>
